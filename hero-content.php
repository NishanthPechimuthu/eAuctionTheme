...
<head>
  ...
  <style>
    ...
    /* Custom Carousel Styles (unchanged) */
...
<body>
    ...
    <div class="content mt-5">
      <div class="row">
        ...
        <div class="col-md-12 mb-1">
          <div class="m-2 card min-vh-100 animate__animated animate__fadeInUp">
  ...
  <script>
    ...
    // GSAP animations for card content
    gsap.from('.card', {
      duration: 1,
      y: 50,
      opacity: 0,
