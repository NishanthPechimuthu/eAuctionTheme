    ...
    <div class="text-left text-md-left">
      <div class="row justify-content-start">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
          ...
          <p><a href="./public/auctions.php" class="footer-link">Auctions</a></p>
          <p><a href="./public/add-auction.php" class="footer-link">Add Auctions</a></p>
          <p><a href="./public/manage-auction.php" class="footer-link">Manage Auction</a></p>
        </div>
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
          <h5 class="text-uppercase mb-4 font-weight-bold footer-heading">Useful links</h5>
          <p><a href="./public/profile.php" class="footer-link">Your Account</a></p>
          <p><a href="./public/revisited-auctions.php" class="footer-link">Your Participated Auctions</a></p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
          ...
          <p><i class="fas fa-envelope mr-3"></i> <a class="footer-link" href="mailto:eagri.ct.ws@gmail.com">eagri.ct.ws@gmail.com</a></p>
      ...
      <div class="row justify-content-start align-items-center">
        <div class="col-md-7 col-lg-8">
          <p class="footer-copyright">Copyright © 2024 - 2025 All rights reserved by:
            <a href="mailto:eagri.ct.ws@gmail.com" class="footer-link">
              <strong>eAgri[NSCBG]</strong>
            </a>
          </p>
        </div>
      </div>
